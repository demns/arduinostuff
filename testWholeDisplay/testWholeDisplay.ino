...
{
  byte numDigits = 4;   
  byte digitPins[] = {6, 8, 9, 12}; //Digits: 1,2,3,4 <--put one resistor (ex: 220 Ohms, or 330 Ohms, etc, on each digit pin)
  byte segmentPins[] = {11, 7, 4, 2, 1, 10, 5}; //Segments: A,B,C,D,E,F,G,Period
...
{
  //local vars
  static byte decPlace = 1;
  
  sevseg.setNumber(3141,0);
